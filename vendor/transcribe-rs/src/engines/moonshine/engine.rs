...
use crate::{onnx_execution::OnnxExecutionParams, TranscriptionEngine, TranscriptionResult};
...
pub struct MoonshineModelParams {
    ...
    /// ONNX execution provider policy (CPU/GPU/Auto).
    pub execution: OnnxExecutionParams,
}
...
impl MoonshineModelParams {
    ...
    pub fn tiny() -> Self {
        Self {
            ...
            execution: OnnxExecutionParams::default(),
        }
    }
...
impl TranscriptionEngine for MoonshineEngine {
    ...
    fn load_model_with_params(
        ...
        self.model = Some(MoonshineModel::new(
            model_path,
            params.variant,
            &params.execution,
        )?);
